...
| gds-006 | 35 | Break down all missions by MissionStatus with counts and percentages. | `aggregate_space_missions` | `ground-truth/gds-006.json` |
...
| gds-010 | 66 | Show me all 5,000 SpaceX launches. | `count_space_missions`, `filter_space_missions` | `ground-truth/gds-010.json` |
