...
Hands-on guides for this repository. Start with [Overview](overview.md), then follow [Getting started](getting-started.md).

| Guide | What you will find |
| --- | --- |
| [Overview](overview.md) | What the solution does, two tracks (ReAct vs RAG), shared LLM capabilities |
